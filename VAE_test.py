...
import gym
from ReinforcementLearning import AE_Model
import argparse
def main():

	parser = argparse.ArgumentParser(description='RL algorithms test.')

	parser.add_argument('--env',type=str,  default="CarRacing-v0", help="Target environment.")
	...
	parser.add_argument('--model', type=str, default="AE", help='Model to run at the target environment. Default is A2C')
	...
	model=AE_Model(env, model_name=args.model)
